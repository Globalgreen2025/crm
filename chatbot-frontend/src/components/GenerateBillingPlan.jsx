...
import React, { useState, useEffect  } from 'react';
import { Modal, Form, Input, Button, DatePicker, message, Space, Card, Steps, Divider, Row, Col, Typography, Select, Alert, Radio } from 'antd';
import { PlusOutlined, MinusOutlined, DollarOutlined, CalendarOutlined, FileTextOutlined } from '@ant-design/icons';
import axios from 'axios';
import moment from 'moment';
  ...
  const steps = [
    {
      ...
      content: (
        <div style={{ padding: '10px 0' }}>
          <Alert
            message="Choisissez le type de plan de facturation"
            description="Sélectionnez le plan standard recommandé ou créez un plan personnalisé avec vos propres pourcentages."
            type="info"
            ...
            >
              <div style={{ display: 'flex', gap: '16px' }}>
                ...
                <div 
                  style={{ 
                    flex: 1, 
                    border: planType === 'default' ? '2px solid #1890ff' : '1px solid #d9d9d9',
                    borderRadius: '8px',
                    padding: '16px',
                    cursor: 'pointer',
                    background: planType === 'default' ? '#f0f8ff' : 'white'
                  }}
                  onClick={() => setPlanType('default')}
                >
                  <Radio value="default" style={{ display: 'none' }} />
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '24px', color: '#1890ff', marginBottom: '8px' }}>
                      <DollarOutlined />
                    </div>
                    <Title level={5} style={{ margin: '8px 0' }}>Plan Standard</Title>
                    <Text type="secondary">Recommandé</Text>
                    <div style={{ marginTop: '12px', padding: '8px', background: '#f6ffed', borderRadius: '4px' }}>
                      <Text strong>30%</Text>
                      <Text type="secondary"> - Acompte</Text>
                      <br />
                      <Text strong>70%</Text>
                      <Text type="secondary"> - Intermédiaire</Text>
                    </div>
                  </div>
                </div>
                ...
                <div 
                  style={{ 
                    flex: 1, 
                    border: planType === 'custom' ? '2px solid #1890ff' : '1px solid #d9d9d9',
                    borderRadius: '8px',
                    padding: '16px',
                    cursor: 'pointer',
                    background: planType === 'custom' ? '#f0f8ff' : 'white'
                  }}
                  onClick={() => setPlanType('custom')}
                >
                  <Radio value="custom" style={{ display: 'none' }} />
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ fontSize: '24px', color: '#1890ff', marginBottom: '8px' }}>
                      <CalendarOutlined />
                    </div>
                    <Title level={5} style={{ margin: '8px 0' }}>Plan Personnalisé</Title>
                    <Text type="secondary">Flexible</Text>
                    <div style={{ marginTop: '12px', padding: '8px', background: '#fff7e6', borderRadius: '4px' }}>
                      <Text>Choisissez vos propres</Text>
                      <br />
                      <Text>pourcentages</Text>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div style={{ padding: '10px 0' }}>
          ...
          <div style={{ marginTop: '24px', display: 'flex', justifyContent: 'space-between' }}>
            ...
            <Button 
              type="primary" 
              onClick={() => form.submit()}
              disabled={planType === 'custom' && customInstallments.length === 0}
            >
              Générer le plan
            </Button>
          </div>
